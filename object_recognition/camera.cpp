...
int Camera::binarize()
{
	...
	cv::inRange(hsv,cv::Scalar(0,160,160),cv::Scalar(3,255,MAX_VALUE),hsv_filtered15);
	cv::inRange(hsv,cv::Scalar(175,160,160),cv::Scalar(180,255,MAX_VALUE),hsv_filtered180);
