...
int Camera::takePhoto()
{
	...
	std::cout<<full_command_string<<std::endl;
...
int Camera::binarize()
{
	...
	cv::inRange(hsv,cv::Scalar(0,64,70),cv::Scalar(10,255,MAX_VALUE),hsv_filtered15);
	cv::inRange(hsv,cv::Scalar(170,64,70),cv::Scalar(180,255,MAX_VALUE),hsv_filtered180);
