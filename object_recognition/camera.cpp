...
int Camera::binarize()
{
	...
	cv::inRange(hsv,cv::Scalar(0,120,200),cv::Scalar(13,255,MAX_VALUE),hsv_filtered15);
	cv::inRange(hsv,cv::Scalar(175,120,200),cv::Scalar(180,255,MAX_VALUE),hsv_filtered180);
